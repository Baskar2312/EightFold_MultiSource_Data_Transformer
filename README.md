...
mvn spring-boot:run
```
*The backend will automatically create the `candidate_profile_builder` database in MySQL if it doesn't exist.*
...
2. `sample-data/sample_resume.pdf`

### Quick Upload Demo:
1. Open `http://localhost:5173/upload`.
2. Select `sample_resume.pdf` for Resume PDF.
